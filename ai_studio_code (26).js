/**
 * MP MARKET BACKEND
 * Cloudflare Worker + D1 + R2 + Durable Objects + Yoco Checkouts + Brevo Transactional Emails + Google Auth + Product Colors
 */
...
// BREVO EMAIL DISPATCHER (WITH REPLY-TO TO GMAIL)
...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // 🖼️ R2 IMAGE SERVING (Handles %2F and clean prefixes)
      if (
      ...
      // CHECKOUT SESSION CREATOR (WITH SELECTED COLOR SAVED)
