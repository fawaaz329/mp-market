/**
 * MP MARKET BACKEND
 * Cloudflare Worker + D1 + R2 + Durable Object WebSockets + Yoco + Universal Multi-Field Search
 */
...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // UNIVERSAL MULTI-FIELD SEARCH ENDPOINT
      if (url.pathname === "/api/products" && request.method === "GET") {
        ...
        if (search && search.trim()) {
          // Universal Search across title, description, and supplier name
