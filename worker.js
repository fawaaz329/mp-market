...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // ⚙️ CONFIG WITH DYNAMIC MINIMUM ORDER, HIDDEN CATEGORIES & MITCHELL'S PLAIN ONLY MODE
      ...
      if (url.pathname.startsWith("/api/admin")) {
        ...
        // ⚙️ SAVE STORE SETTINGS (DYNAMIC MINIMUM ORDER, FEES & MITCHELL'S PLAIN ONLY)
